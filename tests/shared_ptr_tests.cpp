...
TEST(SharedPtrCopying, CopyAssignmentOperator)
{
    sSTL::shared_ptr<int> sptr1 {new int {10}};
    sSTL::shared_ptr<int> sptr2 {new int {20}};
...
TEST(SharedPtrCopying, CopyAssignmentOperatorEmpty)
{
    sSTL::shared_ptr<int> sptr1 {new int {10}};
    sSTL::shared_ptr<int> sptr2 {};
...
TEST(SharedPtrMove, MoveConstructorTransfersOwnershipSafely)
{
...
TEST(SharedPtrMove, MoveAssignmentTransfersOwnershipSafely)
{
